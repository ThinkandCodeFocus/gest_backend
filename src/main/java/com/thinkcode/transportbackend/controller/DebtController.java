...
public class DebtController {
    ...
    public List<Debt> findAll() {
        return debtService.findAll(authenticatedCompanyProvider.requireCompanyId());
    }

    @PostMapping
    @PreAuthorize("hasAnyRole('ADMIN', 'OPERATIONS_MANAGER', 'ASSISTANT')")
    public Debt createManual(@Valid @RequestBody DebtCreateRequest request) {
        return debtService.createManualDebt(request);
    }
